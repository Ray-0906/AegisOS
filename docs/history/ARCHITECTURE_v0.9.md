# AegisOS v0.9 Architecture Diagrams
...
```text
v0.1  Identity + Networking       (Ed25519 keys, encrypted channels)
v0.2  Discovery + Gossip          (Kademlia DHT, membership)
v0.3  Consensus                   (Raft leader election, log replication)
v0.4  Storage                     (AegisFS, chunked encrypted storage)
v0.5  Self-Healing                (Chunk repair, anti-entropy)
v0.6  Snapshots                   (Log compaction, snapshot transfer)
v0.7  Reliable Execution          (Job scheduling, process isolation)
v0.8  Stateful Checkpointing      (Fault-tolerant state recovery)
v0.9  Workspaces + Artifacts      (Dependency management, structured execution)
```
