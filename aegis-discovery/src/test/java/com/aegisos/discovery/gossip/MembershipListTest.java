...
class MembershipListTest {
    ...
    void observeAddsAlivePeer() {
        ...
        MembershipList list = new MembershipList(self, new byte[32], "127.0.0.1:9000", com.aegisos.proto.NodeRole.CLUSTER_MEMBER, 1000, new com.aegisos.core.telemetry.ResourceMonitor(), null);
    ...
    void mergeTakesHigherVersion() {
        NodeId self = randomId(1);
        MembershipList a = new MembershipList(self, new byte[32], "127.0.0.1:9000", com.aegisos.proto.NodeRole.CLUSTER_MEMBER, 1000, new com.aegisos.core.telemetry.ResourceMonitor(), null);
        NodeId peer = randomId(2);
        a.observe(peer, new byte[32], new Endpoint("127.0.0.1", 9001));

        // A second membership list with a fresher view of the same peer.
        MembershipList b = new MembershipList(randomId(3), new byte[32], "127.0.0.1:9002", com.aegisos.proto.NodeRole.CLUSTER_MEMBER, 1000, new com.aegisos.core.telemetry.ResourceMonitor(), null);
